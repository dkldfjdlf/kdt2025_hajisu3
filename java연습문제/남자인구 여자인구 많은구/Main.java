...
public class Main {
    public static void main(String[] args) {
        ...
        Population maxMale = null;
        Population maxFemale = null;

        for (Population p : populationList) {
            if (maxMale == null || p.malePopulation > maxMale.malePopulation) {
                maxMale = p;
            }
            if (maxFemale == null || p.femalePopulation > maxFemale.femalePopulation) {
                maxFemale = p;
            }
        }

        System.out.println("남자인구가 가장 많은 구: " + maxMale.guName + ", 인구수: " + maxMale.malePopulation);
        System.out.println("여자인구가 가장 많은 구: " + maxFemale.guName + ", 인구수: " + maxFemale.femalePopulation);
    }
}