...
public class Main {
    public static void main(String[] args) {
        ...
        // 세대당 인구 가장 많은 구, 가장 적은 구 찾기
        Population maxHouseholdPop = null;
        Population minHouseholdPop = null;

        for (Population p : populationList) {
            if (maxHouseholdPop == null || p.populationPerHousehold > maxHouseholdPop.populationPerHousehold) {
                maxHouseholdPop = p;
            }
            if (minHouseholdPop == null || p.populationPerHousehold < minHouseholdPop.populationPerHousehold) {
                minHouseholdPop = p;
            }
        }

        System.out.println("세대당 인구가 가장 많은 구: " + maxHouseholdPop.guName +
                " (" + maxHouseholdPop.populationPerHousehold + ")");
        System.out.println("세대당 인구가 가장 적은 구: " + minHouseholdPop.guName +
                " (" + minHouseholdPop.populationPerHousehold + ")");
    }
}