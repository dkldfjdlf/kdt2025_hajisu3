...
public class Main {
    public static void main(String[] args) {
        ...
        for (String line : data) {
            ...
            Population p = new Population(guName, guCode, yearMonth, totalPopulation,
                                          householdCount, populationPerHousehold,
        ...
        for (Population p : populationList) {
            totalSum += p.totalPopulation;
            count++;
        }

        double average = (double) totalSum / count;
        System.out.println("서울 평균 구 인구수: " + average);
    }
}